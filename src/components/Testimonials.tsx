...
const Testimonials: React.FC = () => {
  const testimonials = [
    {
      text: 'Fantastic customer service. I worked with their team and love their customer service help me answer all the questions that I needed to complete my work.',
      author: 'K Oiwake',
    },
    {
      text: 'Fantastic customer service. I worked with their team and love their customer service help me answer all the questions that I needed to complete my work.',
